 ...
 * @author Lama1
 */
public class Solution8 extends SolutionBase implements Solver {
    
    private ArrayList<DataFileOut> solutions = new ArrayList<>();
    
    public Solution8()
    {
        super(App.Name + "_Solution8");
    }
    ...
    public DataFileOut solve(DataFileIn dataFileIn)
    {
        ...
        while(daysLeft > 0)
        {
            ...
            var noOfProcessingDays = daysLeft - library.SignUpProcess;
            var done = false;
            var b = 0;
            ...
            {
                var daysLeftForThisLibrary = daysLeft - lib.SignUpProcess;
                var lb = 0;
                var ldone = false;
