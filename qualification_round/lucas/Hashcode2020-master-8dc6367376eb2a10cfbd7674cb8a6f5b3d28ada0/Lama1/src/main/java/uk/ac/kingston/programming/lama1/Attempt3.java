...
public class Attempt3 {
    ...
    public static void main(String[] args)
    {
        var challenges = new Challenge[] {
            new Challenge("a_example.txt", new Solution[] {new Solution3()}),
            new Challenge("b_read_on.txt", new Solution[] {new Solution3()}),
            new Challenge("c_incunabula.txt", new Solution[] {new Solution3()}),
            new Challenge("d_tough_choices.txt", new Solution[] {new Solution3()}),
            new Challenge("e_so_many_books.txt", new Solution[] {new Solution3()}),
            new Challenge("f_libraries_of_the_world.txt", new Solution[] {new Solution3()})
        };
