 ...
 * @author Lama1
 */
public class SolutionLibrarySorter4 extends SolutionBase {
    ...
    public SolutionLibrarySorter4(String id, LibraryInfoSorter libraryInfoSorter, int filter, int noOfCandidates, int scoreToBeat)
    {
        super(App.Name + "_SolutionLibrarySorter4");       
        this.id = id;
