 ...
 * @author Lama1
 */
public class Solution2E2 extends SolutionBase {
    ...
    public Solution2E2(String id, LibraryInfoSorter libraryInfoSorter, int noOfCandidates, int scoreToBeat)
    {
        super(App.Name + "_Solution2E2");       
        this.id = id;
    ...
    public DataFileOut solve(DataFileIn dataFileIn)
    {
        ...
        System.out.println(maxBookScore);
        ...
        {
            if(library.MaxScorePerDay < 15000 || (library.Books.size()/library.NoOfDays) < 1
                    || library.SignUpProcess > 4 || library.ShipPerDay < 2)
            {
        ...
        for(var i = 129; i < libraryList.size(); i++)
        {
        ...
        {
            System.out.println(library.Id + " - " + (library.Books.size()/library.NoOfDays) + " - " + library.ShipPerDay + " - " + library.SignUpProcess + " - " + library.MaxScore + " - " + library.MaxScorePerDay);    
        }
