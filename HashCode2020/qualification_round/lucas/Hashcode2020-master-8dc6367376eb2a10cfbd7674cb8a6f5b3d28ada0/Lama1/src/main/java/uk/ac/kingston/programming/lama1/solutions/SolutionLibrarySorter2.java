 ...
 * @author Lama1
 */
public class SolutionLibrarySorter2 extends SolutionBase {
    ...
    public SolutionLibrarySorter2(String id, LibraryInfoSorter libraryInfoSorter, int noOfCandidates, int scoreToBeat)
    {
        super(App.Name + "_SolutionLibrarySorter2");       
        this.id = id;
