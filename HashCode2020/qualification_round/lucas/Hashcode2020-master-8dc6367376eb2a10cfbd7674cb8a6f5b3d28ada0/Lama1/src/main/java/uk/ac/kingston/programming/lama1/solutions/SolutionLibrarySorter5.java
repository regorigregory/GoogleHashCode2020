 ...
 * @author Lama1
 */
public class SolutionLibrarySorter5 extends SolutionBase {
    ...
    public SolutionLibrarySorter5(String id, LibraryInfoSorter libraryInfoSorter, int filter, int noOfCandidates, int scoreToBeat)
    {
        super(App.Name + "_SolutionLibrarySorter5");       
        this.id = id;
